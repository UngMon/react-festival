...
const PrivacyPolicy = () => {
  return (
    <section className="Text-Container">
      ...
      <p>
        이곳저곳(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사
      ...
      <ol>
        <li>
          ...
          <ol>
            <li>
              <span>Google (Firebase)</span>에{" "}
              <span>사용자 인증 및 소셜 로그인 기능 제공</span>을 위하여{" "}
              <span>최소한의 식별 정보</span>를 제공
            </li>
          </ol>
        </li>
        <li>
      ...
      <p>
        ...
        파기합니다. 특히,
        <strong>
          이용자가 회원 탈퇴(계정 삭제)를 요청하는 경우, 수집된 개인정보 및
          서비스 내 모든 활동 내역은 유예 기간 없이 즉시 영구 삭제됩니다.
        </strong>
      </p>
      <ol>
        <li>
          이용자가 회원가입 등을 위해 입력한 정보는 개인정보 처리 목적이 달성된
          후, 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라 지체 없이
          파기됩니다.
        </li>
        <li>
      ...
      <p>
        제1조 본 방침은 <span>2026.04.06.</span>부터 시행됩니다.
      </p>
    </section>
  );
};
