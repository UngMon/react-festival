...
const slideData = [
  [
    ...
    {
      title: "고요새",
      text: "제주시 동쪽에 위치한 차분한 삼양 검은 모래해변에서 스스로와 마주하는 조용한 시간을 위한, 고요하고 오롯한 나의 요새 컨셉을 가진 카페다. '고요새'에서 알 수 있듯, 공간을 함께 나누는 타인을 배려하여 대화는 소곤하게 하는 것이 특징이다.",
      images: [
        "고요새1.jpeg",
        "고요새2.jpeg",
        "고요새3.jpeg",
  ...
  [
    ...
    },
    {
      ...
      text: `탬버린즈는 감각적 아트와 아름다움을 지향하는 코스메틱 브랜드입니다. 성수동의 플래그십스토어는 외관이 독특하다. 노출 콘크리트 기둥 사이에 유리를 배치하여 지나가는 사람들도 하여금 호기심을 불러 일으킵니다. 실내는 좋은 향으로 가득차 있어, 천장 유리너머로 보이는 콘크리트 기둥과 대비되는 느낌을 주어 묘한 감정을 느끼게 합니다.`,
      images: [],
      sigun: "서울 성동구",
...
const Theme = () => {
  ...
  const slideBoxRef = useRef<Array<HTMLDivElement | null>>([]);
